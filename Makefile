...
.PHONY: generate
generate: controller-gen proto-gen ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
...
.PHONY: proto-gen
proto-gen: buf protoc-gen-go protoc-gen-go-grpc ## Generate protobuf Go code.
